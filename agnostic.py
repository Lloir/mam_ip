...
class MAMUpdaterApp:
    ...
    def create_widgets(self):
        ...
        mam_cookie_label_ttp = CreateToolTip(mam_cookie_label, "Your session cookie from the MyAnonamouse website.\nThis is used to authenticate your account.\nYou can find it in your browser's cookies when logged into MAM.")
...
1. **MAM Session Cookie**:
   - This is a code that identifies you on the MAM website.
   - To find it:
     - Open your web browser and log into MAM.
     - Access your browser's settings to view cookies.
     - Look for a cookie named 'mam_id' from myanonamouse.net.
...
""")
    ...
    def update_seedbox_ip(self, mam_cookie, cookiefile, url):
        try:
            ...
            elif message == "Last change too recent":
                return True, f"No change made: {message}"
            else:
